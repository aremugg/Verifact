      ...
      <div class="app-main-layout">
        <div class="app-main-layout-header">
          <div class="app-main-layout-wrapper header">
            <h1 class="heading-5">Compliance</h1>
          ...
          <div class="compliance-wrapper">
            <div class="progress-nav">
              <div class="div-block-14">
                ...
                <div class="text-block-10">2 of 3 complete</div>
              </div>
              <div class="div-block-15">
                <div class="div-block-16"><img :src="require('@/assets/images/checked.svg')" loading="lazy" width="20" alt=""></div>
                <div>
              ...
              <div class="div-block-15">
                <div class="div-block-16"><img :src="require('@/assets/images/1.svg')" loading="lazy" width="20" alt=""></div>
                <div>
            ...
            <div class="div-block-11">
              <div class="div-block-17">
                <div class="text-block-11">Document Upload</div>
                <div class="text-block-2">Please upload all document</div>
                <div class="form-block-2 w-form">
                  <form id="email-form" name="email-form" data-name="Email Form" redirect="https://verificate-web-portal.webflow.io/compliance-form-filled" data-redirect="https://verificate-web-portal.webflow.io/compliance-form-filled" method="get"><input type="submit" value="Save" data-wait="Please wait..." class="submit-button-2 w-button"></form>
                ...
                <div class="div-block-19">
                  <div class="div-block-20">
                    <div>CAC Document</div>
                    <a data-w-id="a7c28265-d449-6ba2-7e54-6fd414adf5a1" href="#" class="button-6 w-button">Edit</a>
                  </div>
                  <a style="display:none" href="#" class="button-9 w-button">+ Choose file</a>
                  <div style="display:none" class="div-block-23">
                    <a data-w-id="bec0eb0b-2189-f24a-2fb7-cf57af5515ec" href="#" class="button-7 w-button">Cancel</a>
                    <a href="#" class="button-8 w-button">Save</a>
                  </div>
                </div>
                <div class="div-block-19-copy">
                  <div class="div-block-20-copy">
                    <div>Memorandum</div>
                    <a data-w-id="44a8a664-9c34-2cc5-7e22-9192b9c62dbc" href="#" class="button-6-copy w-button">Edit</a>
                  </div>
                  <a style="display:none" href="#" class="button-9-copy w-button">+ Choose file</a>
                  <div style="display:none" class="div-block-23-copy">
                    <a data-w-id="44a8a664-9c34-2cc5-7e22-9192b9c62dc1" href="#" class="button-7-copy w-button">Cancel</a>
                    <a href="#" class="button-8 w-button">Save</a>
                  </div>
                </div>
                <router-link to="/compliance-document-upload-complete" class="button-5 w-button">Save</router-link>
              </div>
            </div>
          </div>
          <div class="footer">
