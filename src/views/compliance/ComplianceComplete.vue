            ...
            <div class="div-block-11">
              <div class="div-block-17-copy">
                <div class="single-layout-right-content-copy">
                  <div class="div-block">
                    <div data-w-id="9e5eecd5-39b1-905c-2378-2d370810a512" data-animation-type="lottie" data-src="documents/64787-success.json" data-loop="0" data-direction="1" data-autoplay="1" data-is-ix2-target="0" data-renderer="svg" data-default-duration="2" data-duration="0" class="lottie-animation"></div>
                  </div>
                  <div class="text-block-3">Success</div>
                  <div class="text-block-4">KYC done successfully</div>
                  <router-link to="/dashboard" class="button-2 w-button">Back to home</router-link>
                </div>
              </div>
            </div>
          </div>
