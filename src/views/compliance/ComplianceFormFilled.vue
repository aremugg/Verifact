          ...
          <div class="compliance-wrapper">
            ...
            <div class="div-block-11">
              <div class="div-block-17">
                <div class="business-rc-number">
                  <div class="text-block-13">Business RC Number</div>
                  <div class="text-block-12">0123456789</div>
                </div>
                <div class="business-rc-number">
                  <div class="text-block-13">Director&#x27;s Full Name</div>
                  <div class="text-block-12">Orofin Oluwaseun Godwin</div>
                </div>
                <div class="business-rc-number">
                  <div class="text-block-13">Director&#x27;s Phone Number</div>
                  <div class="text-block-12">09023321013</div>
                </div>
                <div class="business-rc-number">
                  <div class="text-block-13">Director&#x27;s Email Address</div>
                  <div class="text-block-12">seansharpzy@gmail.com</div>
                </div>
                <div class="business-rc-number">
                  <div class="text-block-13">Director&#x27;s Gender</div>
                  <div class="text-block-12">Male</div>
                </div>
                <div class="business-rc-number">
                  <div class="text-block-13">Director&#x27;s Gender</div>
                  <div class="text-block-12">Male</div>
                ...
                <div class="div-block-18">
                  <router-link to="/compliance" class="edit-button w-button">Edit</router-link>
                  <router-link to="/compliance-bank-details" class="next-button w-button">Next</router-link>
                </div>
              </div>
            </div>
          </div>
