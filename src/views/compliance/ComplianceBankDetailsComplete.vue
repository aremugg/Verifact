            ...
            <div class="div-block-11">
              <div class="div-block-17">
                <div class="business-rc-number">
                  <div class="text-block-13">Bank Name</div>
                  <div class="text-block-12">Guarantee Trust Bank</div>
                </div>
                <div class="business-rc-number">
                  <div class="text-block-13">Account Name</div>
                  <div class="text-block-12">Orofin Oluwaseun Godwin</div>
                </div>
                <div class="business-rc-number">
                  <div class="text-block-13">Account Number</div>
                  <div class="text-block-12">0123456789</div>
                </div>
                <div class="div-block-18">
                  <router-link to="/compliance-bank-details" class="edit-button w-button">Edit</router-link>
                  <router-link to="/compliance-document-upload" class="next-button w-button">Next</router-link>
                </div>
              </div>
            </div>
          </div>
