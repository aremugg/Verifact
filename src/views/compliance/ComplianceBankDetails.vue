          ...
          <div class="compliance-wrapper">
            <div class="progress-nav">
              <div class="div-block-14">
                ...
                <div class="text-block-10">1 of 3 complete</div>
              </div>
              ...
              <div class="div-block-15">
                <div class="div-block-16"><img :src="require('@/assets/images/Ellipse-38.svg')" loading="lazy" width="20" alt=""></div>
                <div>
            ...
            <div class="div-block-11">
              <div class="div-block-17">
                <div class="text-block-11">Bank Details</div>
                <div class="form-block-2 w-form">
                  <form id="email-form" name="email-form" data-name="Email Form" redirect="https://verificate-web-portal.webflow.io/compliance-form-filled" data-redirect="https://verificate-web-portal.webflow.io/compliance-form-filled" method="get">
                    <div class="rc-number">
                      <div class="text-block-2">Bank Name</div><input type="text" class="input w-input" maxlength="256" name="First-Name" data-name="First Name" placeholder="" id="First-Name" required="">
                    </div>
                    <div class="rc-number">
                      <div class="text-block-2">Account Name</div><input type="text" class="input w-input" maxlength="256" name="First-Name-2" data-name="First Name 2" placeholder="" id="First-Name-2" required="">
                    </div>
                    <div class="rc-number">
                      <div class="text-block-2">Account Number</div><input type="text" class="input w-input" maxlength="256" name="First-Name-2" data-name="First Name 2" placeholder="" id="First-Name-3" required="">
