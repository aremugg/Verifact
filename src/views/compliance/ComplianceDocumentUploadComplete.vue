          ...
          <div class="compliance-wrapper">
            <div class="progress-nav">
              <div class="div-block-14">
                ...
                <div class="text-block-10">3 of 3 complete</div>
              </div>
              ...
              <div class="div-block-17">
                ...
                <div class="div-block-19">
                  <div class="div-block-20">
                    <div>CAC Document</div><img :src="require('@/assets/images/checked.svg')" loading="lazy" width="24" alt="">
                  </div>
                </div>
                <div class="div-block-19-copy">
                  <div class="div-block-20-copy">
                    <div>Memorandum</div><img :src="require('@/assets/images/checked.svg')" loading="lazy" width="24" alt="">
                  </div>
                </div>
                <div class="div-block-18">
                  <router-link to="/compliance-document-upload" class="edit-button w-button">Edit</router-link>
                  <router-link to="/compliance-complete" class="next-button w-button">Next</router-link>
                </div>
              </div>
            </div>
          </div>
