    ...
    <div class="app-main-layout-container">
      ...
      <div class="app-main-layout">
        ...
        <div class="app-main-layout-wrapper body">
          <div class="verification-wrapper-copy"><img :src="require('@/assets/images/Frame.svg')" loading="lazy" width="75.5" alt="">
            <h1 class="heading-6">Address Verification</h1>
            <div class="verification-report-wrapper">
              <div class="verification-report">
                <div class="text-block-15"><strong class="bold-text">ADDRESS OR LANDMARKS &amp; DIRECTIONS</strong></div>
                <div>4517 Washington Ave. Manchester, Kentucky 39495</div>
              </div>
              <div class="verification-report">
                <div class="text-block-15"><strong class="bold-text">STATE</strong></div>
                <div>Lagos State</div>
              </div>
              <div class="verification-report">
                <div class="text-block-15"><strong class="bold-text">LGA</strong></div>
                <div>Alimosho LGA</div>
              </div>
              <div class="verification-report">
                <div class="text-block-15"><strong class="bold-text">LGA</strong></div>
                <div>Alimosho LGA</div>
              ...
              <div class="verification-report">
                <div class="text-block-15"><strong>CITY</strong></div>
                <div>Ikotun</div>
              </div>
              <div class="div-block-26">
                <a href="#" class="accept-button w-button">Accept</a>
                <a href="#" class="accept-button w-button">Decline</a>
              </div>
            </div>
          </div>
          <div class="footer">
