        ...
        <div class="app-main-layout-wrapper body">
          <div class="verification-wrapper-copy"><img :src="require('@/assets/images/agt-mgt.svg')" loading="lazy" width="75.5" alt="">
            ...
            <div class="verification-report-wrapper">
              <div class="single-layout-right-content-copy">
                <div class="div-block">
                  <div data-w-id="cb42be8b-327c-4085-5c37-e9540b548af7" data-animation-type="lottie" data-src="documents/64787-success.json" data-loop="0" data-direction="1" data-autoplay="1" data-is-ix2-target="0" data-renderer="svg" data-default-duration="2" data-duration="0" class="lottie-animation"></div>
                </div>
                <div class="text-block-3">Success</div>
                <div class="text-block-4">Agent details updated successfully</div>
                <router-link to="/agent-management-view" class="button-2 w-button">Continue</router-link>
              </div>
            </div>
          </div>
          <div class="footer">
