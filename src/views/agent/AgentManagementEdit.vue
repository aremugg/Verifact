        ...
        <div class="sidebar-navbar-container w-container">
          ...
          <nav role="navigation" class="sidebar-navbar-menu w-nav-menu">
            ...
            <div class="sidebar-navbar-footer">
              ...
              <a href="#" class="sidebar-navbar-link link-logout w-nav-link">Logout</a>
            </div>
    ...
    <div class="app-main-layout-container">
      ...
      <div class="app-main-layout">
        <div class="app-main-layout-header">
          <div class="app-main-layout-wrapper header">
            <div class="div-block-24">
              <h1 class="heading-5">
                <router-link to="/verification-management" class="link-405">Back</router-link>
              </h1>
            </div>
        ...
        <div class="app-main-layout-wrapper body">
          <div class="verification-wrapper-copy"><img :src="require('@/assets/images/agt-mgt.svg')" loading="lazy" width="75.5" alt="">
            <h1 class="heading-6">Agent Management</h1>
            <div class="verification-report-wrapper">
              <div class="form-block-2-copy w-form">
                <form id="email-form" name="email-form" data-name="Email Form" redirect="https://verificate-web-portal.webflow.io/compliance-form-filled" data-redirect="https://verificate-web-portal.webflow.io/compliance-form-filled" method="get">
                  <div class="fname">
                    <div class="text-block-2">First Name</div><input type="text" class="input w-input" maxlength="256" name="First-Name" data-name="First Name" placeholder="" id="First-Name" required="">
                  </div>
                  <div class="lname">
                    <div class="text-block-2">Last Name</div><input type="text" class="input w-input" maxlength="256" name="First-Name-2" data-name="First Name 2" placeholder="" id="First-Name-2" required="">
                  </div>
                  <div class="email">
                    <div class="text-block-2">Email Address</div><input type="text" class="input w-input" maxlength="256" name="First-Name-2" data-name="First Name 2" placeholder="" id="First-Name-3" required="">
                  </div>
                  <div class="phone-no-block">
                    <div class="text-block-2">Phone Number</div><input type="text" class="input w-input" maxlength="256" name="First-Name-2" data-name="First Name 2" placeholder="" id="First-Name-4" required="">
                  </div>
                  <div class="status">
                    <div class="text-block-2">Status</div><select id="field" name="field" data-name="Field" class="select-field w-select">
                    <option value="">Select one...</option>
                    <option value="First">Active</option>
                    <option value="Second">Inactive</option>
                    <option value="Third">Third choice</option>
                  </select>
                  </div><input type="submit" value="Save" data-wait="Please wait..." class="submit-button-2 w-button">
                  <router-link to="/compliance-bank-details-complete" class="button-5 w-button">Save</router-link>
                </form>
          ...
          <div class="footer">
            <div class="w-row">
              <div class="w-col w-col-6">
                <div class="hint-2">© Copyright Verificate. All rights reserved</div>
              </div>
